...
exports.default = _react2.default.createClass({
                ...
                if (leftNode.getBoundingClientRect) {
                    ...
                    if (rightRef) {
                        ...
                        if (rightPaneSize < this.props.minSize) {
                            ...
                            this.updateLeftSizeAndTriggerChange(_leftSize - gap);
                        }
    ...
    updateLeftSizeAndTriggerChangeAndTriggerChange: function updateLeftSizeAndTriggerChangeAndTriggerChange(newSize) {
